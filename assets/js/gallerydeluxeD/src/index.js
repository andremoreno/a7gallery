		...
		const openActiveImage = () => {
			...
			if (activeImage) {
				...
				if (params.enable_exif) {
					...
					// temp fix to not showing the date if disableDate is true
					if (!activeImage.exif.Date.includes('0001')) {
				...
				// I dont need the original size to show
				// fullImage.src = activeImage.['960'];
